...
- **email**: Email portal (akan replace "bandungbersuara@gmail.com")
- **socialHandle**: Handle social media (akan replace "bandungbersuara")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #BE123C → custom)
  - **dark**: Warna gelap hitam (contoh: #4C0519 → custom)
...
| `bandungbersuara` | `siteName` (tanpa spaces) |
| `bandungbersuara` | `socialHandle` |
| `bandungbersuara@gmail.com` | `email` |
| `#BE123C` (primary) | Warna primary dari config |
| `#4C0519` (dark) | Warna dark dari config |
| `#1F5F1F` (secondary) | Warna secondary dari config |
