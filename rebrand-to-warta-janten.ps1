# Rebrand dari Bandung Bersuara ke Bandung Bersuara
...
foreach ($file in $htmlFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = "Bandung Bersuara"; New = "Bandung Bersuara" },
            @{ Old = "Bandung Bersuara"; New = "Bandung Bersuara" },
            @{ Old = "bandungbersuara"; New = "bandungbersuara" },
            # Social media links
            @{ Old = "https://twitter.com/bandungbersuara"; New = "https://twitter.com/bandungbersuara" },
            @{ Old = "https://facebook.com/bandungbersuara"; New = "https://facebook.com/bandungbersuara" },
            @{ Old = "https://instagram.com/bandungbersuara"; New = "https://instagram.com/bandungbersuara" },
            @{ Old = "https://youtube.com/@bandungbersuara"; New = "https://youtube.com/@bandungbersuara" },
            @{ Old = "https://linkedin.com/company/bandungbersuara"; New = "https://linkedin.com/company/bandungbersuara" },
            # Email
            @{ Old = "bandungbersuara@gmail.com"; New = "bandungbersuara@gmail.com" },
            # Logo references
            @{ Old = 'alt="BandungBersuara"'; New = 'alt="BandungBersuara"' }
        )
...
foreach ($file in $cssFiles) {
    try {
        ...
        # Color replacements
        $colorReplacements = @(
            @{ Old = "#BE123C"; New = "#BE123C" },          # Primary: kuning -> hijau
            @{ Old = "#be123c"; New = "#BE123C" },
            @{ Old = "rgb(255, 204, 0)"; New = "rgb(6, 95, 70)" },
            @{ Old = "#1F5F1F"; New = "#1F5F1F" },          # Secondary: abu -> biru
            @{ Old = "#4C0519"; New = "#4C0519" },          # Dark: hitam -> darkgreen
            # Additional color mappings if needed
            @{ Old = "#4c0519"; New = "#4C0519" }
        )
...
foreach ($file in $packageJsonFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = """name"": ""bandungbersuara"""; New = """name"": ""bandungbersuara""" },
            @{ Old = """name"": ""bandungbersuara-article-generator"""; New = """name"": ""bandungbersuara-article-generator""" }
        )
...
$searchPatterns = @("Bandung Bersuara", "bandungbersuara", "Bandung Bersuara")
$foundIssues = @()
